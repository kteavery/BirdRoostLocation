"""
from https://github.com/ARM-DOE/pyart/blob/master/pyart/default_config.py
...
DEFAULT_FIELD_LIMITS = {
    ...
    "DBZ_S": (-10.0, 30.0),
    "DBZ_K": (-10.0, 30.0),
    "reflectivity_horizontal": (-10.0, 30.0),
    "corr_reflectivity": (-10.0, 30.0),
}
