    ...
    def __get_radar_product_path(self, root_dir, radar_product, is_roost):
        if is_roost:
            return os.path.join(
                ...
                f"{self.fileName}_{radar_product}" + ".png",
            )
        else:
            return os.path.join(
                root_dir,
            ...
            paths.extend(
                [
                    ...
                    os.path.join(
                        ...
                        + roost
                        + f"{radar_product}/"
                        + f"{self.fileName}_{radar_product}_flip.png"
                    ),
                    os.path.join(
                        root_dir
                        + "data/Noise_Flip_"
                        + roost
                        + f"{radar_product}/"
                        + f"{self.fileName}_{radar_product}_flip_noise.png"
                    ),
                    os.path.join(
                        root_dir,
                        "data/Noise_" + roost + f"{radar_product}/",
                        f"{self.fileName}_{radar_product}_noise.png",
                    ),
                ]
            )
                ...
                paths.extend(
                    [
                        os.path.join(
                            ...
                            f"{self.fileName}_{radar_product}_"
                            + angle
                            + "_noise.png",
                        ),
                        os.path.join(
                        ...
                        os.path.join(
                            ...
                            f"{self.fileName}_{radar_product}_flip_"
                            + angle
                            + ".png",
                        ),
                    ]
